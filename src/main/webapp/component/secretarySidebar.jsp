<div class="flex wrapper">
    ...
    <div class="app-menu">
        ...
        <!-- Sidenav Brand Logo -->
        <a href="${pageContext.request.contextPath}/secretary/dashboard.jsp" class="logo-box">
            <!-- Light Brand Logo -->
        ...
        <div class="srcollbar" data-simplebar>
            <ul class="menu" data-fc-type="accordion">
                ...
                <li class="menu-item mt-6">
                    <a href="${pageContext.request.contextPath}/secretary/dashboard.jsp" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="${pageContext.request.contextPath}/secretary/patient/patients.jsp" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="${pageContext.request.contextPath}/secretary/appointment/appointments.jsp" class="menu-link">
