                        ...
                        fetch('${pageContext.request.contextPath}/secretary-servlet')
                            ...
                            .then(data => {
                                ...
                                const grid = new gridjs.Grid({
                                    columns: [
                                        ...
                                        "Telephone",
                                        {
                                            ...
                                            <div class="flex">
                                                ...
                                                <form action="/secretary-servlet" method="post">
                                                    <input type="hidden" name="id" value="` + secretaryId + `">
                                    ...
                                    search: true,
                                    sort: true,
                                    data: data.map(secretary => [
                                        secretary.id ,// This ensures the ID is accessible in the row data
                                        secretary.cin,
                                        secretary.firstName,
                                        secretary.lastName,
                                        secretary.email,
