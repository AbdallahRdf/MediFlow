            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            <i class="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                            <a href="addDoctor.jsp" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Add New Doctor</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex items-center">
                                    ...
                                    <h4 class="card-title ms-2">Add New Doctor</h4>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <form method="post" action="/doctor-servlet">
                                    ...
                                    <button type="submit" class="btn bg-success text-white mt-5">Add Doctor</button>
                                </form>
