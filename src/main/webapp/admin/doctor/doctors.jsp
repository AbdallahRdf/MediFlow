...
<script>
    async function fetchData() {
        try {
            const response = await fetch('${pageContext.request.contextPath}/doctor-servlet');
            ...
            if (document.getElementById("table-search")) {
                const grid = new gridjs.Grid({
                    columns: [
                        ...
                        "Registration",
                        {
                            ...
                            formatter: (cell, row, index) => {
                                console.log("fetched in formatter",data)
                                console.log("index",index)
                                const doctorId = data[index].id;
                    ...
                    data: data.map(doctor => [
                        ...
                        doctor.id // This should match the index used in formatter
                    ])
                });
